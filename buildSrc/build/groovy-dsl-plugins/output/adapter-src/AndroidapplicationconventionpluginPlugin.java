...
/**
 * Precompiled AndroidApplicationConventionPlugin script plugin.
 **/
public class AndroidapplicationconventionpluginPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Androidapplicationconventionplugin").asSubclass(BasicScript.class);
